...
public interface ICatalogServices
{
    ...
    /// descending order: created. Include parameters can be provided to get the following related resource data:
    /// variants.
    /// </summary>
    /// <param name="catalogItemFields">For more information please visit
    /// https://developers.klaviyo.com/en/reference/api-overview#sparse-fieldsets</param>
    /// <param name="catalogVariantFields">For more information please visit
    /// https://developers.klaviyo.com/en/reference/api-overview#sparse-fieldsets</param>
    /// <param name="filter">For more information please visit
    /// <see href="https://developers.klaviyo.com/en/reference/api-overview#filtering" />Allowed fields: ids, category,
    /// title, published</param>
    ...
    /// </summary>
    /// <param name="catalogItemId">The catalog item ID is a compound ID (string), with format:
    /// {integration}:::{catalog}:::{external_id}. Currently, the only supported integration type is $custom, and the
    /// only supported catalog is $default.</param>
    /// <param name="catalogItemFields">For more information please visit
    /// https://developers.klaviyo.com/en/reference/api-overview#sparse-fieldsets</param>
    /// <param name="catalogVariantFields">For more information please visit
    /// https://developers.klaviyo.com/en/reference/api-overview#sparse-fieldsets</param>
    ...
    /// </summary>
    /// <param name="CatalogItemBulkJobFields">For more information please visit
    /// https://developers.klaviyo.com/en/reference/api-overview#sparse-fieldsets</param>
    /// <param name="filter">For more information please visit
    ...
    /// following related resource data: items.
    /// </summary>
    ...
    /// request. The maximum allowed payload size is 4MB.
    /// </summary>
    /// <param name="catalogItemBulkJob">For more information please visit
    /// https://developers.klaviyo.com/en/reference/api-overview#sparse-fieldsets</param>
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    ...
    /// <param name="catalogItemFields">For more information please
    /// visit https://developers.klaviyo.com/en/reference/api-overview#sparse-fieldsets</param>
    /// <param name="catalogVariantFields">For more information please
    /// visit https://developers.klaviyo.com/en/reference/api-overview#sparse-fieldsets</param>
    /// <param name="filter">For more information please visit
    /// <see href="https://developers.klaviyo.com/en/reference/api-overview#filtering" />. Allowed fields: ids,
    /// category, title, published</param>
    /// <param name="includedRecords">For more information please visit
    /// https://developers.klaviyo.com/en/reference/api-overview#relationships</param>
    /// <param name="sort">For more information please visit
    /// https://developers.klaviyo.com/en/reference/api-overview#sorting</param>
    ...
    /// https://developers.klaviyo.com/en/reference/api-overview#sparse-fieldsets</param>
    /// <param name="filter">For more information please visit
    /// <see href="https://developers.klaviyo.com/en/reference/api-overview#filtering" />. Allowed fields: ids, item.id,
    /// sku, title, published</param>
    /// <param name="sort">For more information please visit
    /// https://developers.klaviyo.com/en/reference/api-overview#sorting</param>
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    ...
    /// </summary>
    /// <param name="catalogVariantId">The catalog variant ID is a compound ID (string), with format:
    /// {integration}:::{catalog}:::{external_id}. Currently, the only supported integration type is $custom, and the
    /// only supported catalog is $default.</param>
    /// <param name="catalogVariantFields">For more information please visit
    /// https://developers.klaviyo.com/en/reference/api-overview#sparse-fieldsets</param>
    ...
    /// </summary>
    /// <param name="CatalogVariantBulkJobFields">For more information please visit
    /// https://developers.klaviyo.com/en/reference/api-overview#sparse-fieldsets</param>
    /// <param name="filter">For more information please visit
    /// <see href="https://developers.klaviyo.com/en/reference/api-overview#filtering" />. Allowed fields:status</param>
    /// <param name="cancellationToken"></param>
    ...
    /// variants per request. The maximum allowed payload size is 4MB.
    /// </summary>
    ...
    /// following related resource data: variants.
    /// </summary>
    ...
    /// descending order: created
    /// </summary>
    /// <param name="catalogItemId"></param>
    /// <param name="catalogVariantFields">For more information please visit
    /// https://developers.klaviyo.com/en/reference/api-overview#sparse-fieldsets</param>
    /// <param name="filter">For more information please visit
    /// <see href="https://developers.klaviyo.com/en/reference/api-overview#filtering" />. Allowed fields: ids, item,
    /// sku, title, published</param>
    /// <param name="sort">For more information please visit
    /// https://developers.klaviyo.com/en/reference/api-overview#sorting</param>
    /// <param name="cancellationToken"></param>
    ...
    /// and descending order: created
    /// </summary>
    /// <param name="catalogCategoryFields">For more information please visit
    /// https://developers.klaviyo.com/en/reference/api-overview#sparse-fieldsets</param>
    /// <param name="filter">For more information please visit
    /// <see href="https://developers.klaviyo.com/en/reference/api-overview#filtering" />. Allowed fields: ids,
    /// item, name</param>
    ...
    /// </summary>
    /// <param name="catalogCategoryId">The catalog category ID is a compound ID (string), with format:
    /// {integration}:::{catalog}:::{external_id}. Currently, the only supported integration type is $custom, and the
    /// only supported catalog is $default.</param>
    /// <param name="catalogCategoryFields">For more information please visit
    /// https://developers.klaviyo.com/en/reference/api-overview#sparse-fieldsets</param>
    ...
    /// </summary>
    /// <param name="CatalogCategoryBulkJobFields">For more information please visit
    /// https://developers.klaviyo.com/en/reference/api-overview#sparse-fieldsets</param>
    /// <param name="filter">For more information please visit
    /// <see href="https://developers.klaviyo.com/en/reference/api-overview#filtering" />. Allowed fields:status</param>
    /// <param name="cancellationToken"></param>
    ...
    /// categories per request. The maximum allowed payload size is 4MB.
    /// </summary>
    ...
    /// following related resource data: categories.
    /// </summary>
    ...
    /// following fields, in ascending and descending order: created
    /// </summary>
    /// <param name="catalogItemId"></param>
    /// <param name="catalogCategoryFields">For more information please visit
    /// https://developers.klaviyo.com/en/reference/api-overview#sparse-fieldsets</param>
    ...
    /// <summary>
    /// Subscribe a profile to receive back in stock notifications. Check out our Back in Stock API guide for more
    /// details. This endpoint is specifically designed to be called from server-side applications. To create
    /// subscriptions from client-side contexts, use POST /client/back-in-stock-subscriptions.
    /// </summary>
    /// <param name="backInStockSubscription"></param>
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    Task CreateBackInStockSubscription(BackInStockSubscription backInStockSubscription,
                                       CancellationToken cancellationToken);
    ...
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    Task CreateCatalogCategoryRelationshipsItems(string id,
    ...
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    Task UpdateCatalogCategoryRelationshipsItems(string id,
                                                 DataListObject<GenericObject> relationships,
                                                 CancellationToken cancellationToken);
    /// <summary>
    ...
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    Task DeleteCatalogCategoryRelationshipsItems(string id,
                                                 DataListObject<GenericObject> relationships,
                                                 CancellationToken cancellationToken);
    /// <summary>
    ...
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    Task<DataListObject<GenericObject>> GetCatalogItemRelationshipsCategories(string id,
                                                                              CancellationToken cancellationToken);
    /// <summary>
    ...
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    Task CreateCatalogItemRelationshipsCategories(string id,
                                                  DataListObject<GenericObject> relationships,
                                                  CancellationToken cancellationToken);
    /// <summary>
    ...
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    Task UpdateCatalogItemRelationshipsCategories(string id,
                                                  DataListObject<GenericObject> relationships,
                                                  CancellationToken cancellationToken);
    /// <summary>
    ...
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    Task DeleteCatalogItemRelationshipsCategories(string id,
                                                  DataListObject<GenericObject> relationships,
                                                  CancellationToken cancellationToken);
}