...
public interface IAccountServices
{
    ...
    /// the correct account prior to performing subsequent actions with the API.
    /// </summary>
    /// <param name="accountFields">For more information please visit
    /// <see href="https://developers.klaviyo.com/en/reference/api-overview#sparse-fieldsets">Fieldsets
    /// overview</see></param>
