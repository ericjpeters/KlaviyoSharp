...
{
    /// <summary>
    /// List all tags in an account. Tags can be filtered by name, and sorted by name or id in ascending or descending
    /// order.
    /// </summary>
    ...
    /// <see href="https://developers.klaviyo.com/en/reference/api-overview#filtering" />. Allowed fields: name</param>
    ...
    /// <summary>
    /// Create a tag. An account cannot have more than 500 unique tags. A tag belongs to a single tag group. If the
    /// tag_group_id is not specified, the tag is added to the account's default tag group.
    /// </summary>
    ...
    /// </summary>
    /// <param name="tagId">The Tag ID</param>
    /// <param name="tagGroupFields">For more information please visit
    /// https://developers.klaviyo.com/en/reference/api-overview#sparse-fieldsets</param>
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// ist all tag groups in an account. Every account has one default tag group. Tag groups can be filtered by name,
    /// exclusive, and default, and sorted by name or id in ascending or descending order.
    /// </summary>
    /// <param name="tagGroupFields">For more information please visit
    /// https://developers.klaviyo.com/en/reference/api-overview#sparse-fieldsets</param>
    /// <param name="filter">For more information please visit
    /// <see href="https://developers.klaviyo.com/en/reference/api-overview#filtering" />. Allowed fields: name,
    /// default, exclusive</param>
    /// <param name="sort">For more information please visit
    /// https://developers.klaviyo.com/en/reference/api-overview#sorting</param>
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Create a tag group. An account cannot have more than 50 unique tag groups. If exclusive is not specified true or
    /// false, the tag group defaults to non-exclusive. If a tag group is non-exclusive, any given related resource
    /// (campaign, flow, etc.) can be linked to multiple tags from that tag group. If a tag group is exclusive, any
    /// given related resource can only be linked to one tag from that tag group.
    /// </summary>
    ...
    /// <summary>
    /// Update the tag group with the given tag group ID. Only a tag group's name can be changed. A tag group's
    /// exclusive or default value cannot be changed.
    /// </summary>
    /// <param name="tagGroupId">The Tag Group ID</param>
    /// <param name="tagGroup"></param>
    /// <param name="cancellationToken"></param>
    ...
    /// </summary>
    /// <param name="tagId"></param>
    /// <param name="objects">Use the request body to pass in the ID(s) of the flow(s) that will be associated with the
    /// tag.</param>
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    ...
    /// </summary>
    /// <param name="tagId"></param>
    /// <param name="objects">Use the request body to pass in the ID(s) of the flows(s) whose association with the tag
    ...
    /// </summary>
    /// <param name="tagId"></param>
    /// <param name="objects">Use the request body to pass in the ID(s) of the Campaigns(s) that will be associated with
    /// the tag.</param>
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    ...
    /// </summary>
    /// <param name="tagId"></param>
    /// <param name="objects">Use the request body to pass in the ID(s) of the Campaigns(s) whose association with the
    /// tag will be removed.</param>
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    ...
    /// </summary>
    /// <param name="tagId"></param>
    /// <param name="objects">Use the request body to pass in the ID(s) of the Lists(s) that will be associated with the
    /// tag.</param>
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    ...
    /// </summary>
    /// <param name="tagId"></param>
    /// <param name="objects">Use the request body to pass in the ID(s) of the Lists(s) whose association with the tag
    /// will be removed.</param>
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    ...
    /// </summary>
    /// <param name="tagId"></param>
    /// <param name="objects">Use the request body to pass in the ID(s) of the Segments(s) that will be associated with
    /// the tag.</param>
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    ...
    /// </summary>
    /// <param name="tagId"></param>
    /// <param name="objects">Use the request body to pass in the ID(s) of the Segments(s) whose association with the
    /// tag will be removed.</param>
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
