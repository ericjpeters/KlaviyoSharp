...
{
    /// <summary>
    /// Get all templates in an account. Filter to request a subset of all templates. Templates can be sorted by the
    /// following fields, in ascending and descending order: id, name, created, updated.
    /// </summary>
    ...
    /// <param name="filter">For more information please visit <see href="
    /// https://developers.klaviyo.com/en/reference/api-overview#filtering" />Allowed fields: id, name, created,
    /// updated</param>
    ...
    /// <returns></returns>
    Task<DataListObject<Template>> GetTemplates(List<string> templateFields,
                                                IFilter filter,
                                                string sort,
    ...
    /// <summary>
    /// Create a new custom HTML template. If there are 1,000 or more templates in an account, creation will fail as
    /// there is a limit of 1,000 templates that can be created via the API.
    /// </summary>
