...
public interface IFlowServices
{
    ...
    /// </summary>
    /// <param name="flowFields">For more information please visit
    /// https://developers.klaviyo.com/en/i-overview#sparse-fieldsets</param>
    /// <param name="flowActionFields">For more information please visit
    ...
    /// <see href="https://developers.klaviyo.com/en/reference/api-overview#filtering" />. Allowed fields: id, name,
    /// status, archived, created, updated, trigger_type</param>
    ...
    /// <returns></returns>
    Task<DataListObjectWithIncluded<Flow>> GetFlows(List<string>? flowFields,
                                                    List<string>? flowActionFields,
                                                    List<string>? includedRecords,
                                                    IFilter? filter,
                                                    string? sort,
                                                    CancellationToken cancellationToken);
    /// <summary>
    /// Get a flow with the given flow ID. Include parameters can be provided to get the following related resource
    /// data: flow-actions
    /// </summary>
    ...
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    Task<DataObjectWithIncluded<Flow>?> GetFlow(string? flowId,
                                               List<string>? flowFields,
                                               List<string>? flowActionFields,
                                               List<string>? includedRecords,
                                               CancellationToken cancellationToken);
    /// <summary>
    ...
    /// <summary>
    /// Get a flow action from a flow with the given flow action ID. Include parameters can be provided to get the
    /// following related resource data: flows, flow-messages
    /// </summary>
    /// <param name="flowActionId">Flow Action ID</param>
    /// <param name="flowActionFields">For more information please visit
    /// https://developers.klaviyo.com/en/reference/api-overview#sparse-fieldsets</param>
    /// <param name="flowMessageFields">For more information please visit
    /// https://developers.klaviyo.com/en/reference/api-overview#sparse-fieldsets</param>
    /// <param name="flowFields">For more information please visit
    /// https://developers.klaviyo.com/en/reference/api-overview#sparse-fieldsets</param>
    /// <param name="includedRecords">For more information please visit
    ...
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    Task<DataObject<FlowAction>?> GetFlowAction(string flowActionId,
                                               List<string>? flowActionFields,
                                               List<string>? flowMessageFields,
                                               List<string>? flowFields,
                                               List<string>? includedRecords,
                                               CancellationToken cancellationToken);
    /// <summary>
    /// Get the flow message of a flow with the given message ID. Include parameters can be provided to get the
    /// following related resource data: 'flow-actions'
    /// </summary>
    ...
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    Task<DataObject<FlowMessage>?> GetFlowMessage(string flowMessageId,
                                                 List<string>? flowActionFields,
                                                 List<string>? flowMessageFields,
                                                 List<string>? includedRecords,
                                                 CancellationToken cancellationToken);
    ...
    /// https://developers.klaviyo.com/en/reference/api-overview#sparse-fieldsets</param>
    /// <param name="filter">For more information please visit
    /// <see href="https://developers.klaviyo.com/en/reference/api-overview#filtering" />. Allowed fields: id,
    /// action_type, status, created, updated</param>
    /// <param name="sort">For more information please visit
    /// https://developers.klaviyo.com/en/reference/api-overview#sorting</param>
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    Task<DataListObject<FlowAction>> GetFlowActionsForFlow(string flowId,
                                                           List<string>? flowActionFields,
                                                           IFilter? filter,
                                                           string? sort,
                                                           CancellationToken cancellationToken);
    ...
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    Task<DataObject<Flow>?> GetFlowForFlowAction(string? flowActionId,
                                                List<string>? flowFields,
                                                CancellationToken cancellationToken);
    /// <summary>
    ...
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    Task<DataListObject<FlowMessage>?> GetMessagesForFlowAction(string? flowActionId,
                                                               List<string>? flowMessageFields,
                                                               IFilter? filter,
                                                               string? sort,
                                                               CancellationToken cancellationToken);
    ...
    /// <param name="flowId">Flow ID</param>
    /// <param name="filter">For more information please visit
    /// <see href="https://developers.klaviyo.com/en/reference/api-overview#filtering" />. Allowed fields: action_type,
    /// status, created, updated</param>
    /// <param name="sort">For more information please visit
    /// https://developers.klaviyo.com/en/reference/api-overview#sorting</param>
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    Task<DataListObject<GenericObject>?> GetFlowRelationshipsFlowActions(string? flowId,
                                                                        IFilter? filter,
                                                                        string? sort,
                                                                        CancellationToken cancellationToken);
    /// <summary>
    ...
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    Task<DataObject<GenericObject>?> GetFlowActionRelationshipsFlow(string flowActionId,
                                                                   CancellationToken cancellationToken);
    /// <summary>
    ...
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    Task<DataListObject<GenericObject>> GetFlowActionRelationshipsMessages(string flowActionId,
                                                                           IFilter? filter,
                                                                           string? sort,
                                                                           CancellationToken cancellationToken);
    /// <summary>
