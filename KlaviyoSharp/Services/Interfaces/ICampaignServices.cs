...
public interface ICampaignServices
{
    ...
    /// </summary>
    /// <param name="campaignFields">For more information please visit
    ...
    /// https://developers.klaviyo.com/en/reference/api-overview#sparse-fieldsets</param>
    /// <param name="filter">A filter on messages.channel is required. For more information please visit
    /// <see href="https://developers.klaviyo.com/en/reference/api-overview#filtering" />. Allowed fields: name, status,
    /// archived, created_at, scheduled_at, updated_at</param>
    ...
    /// <param name="campaignRecipientEstimationFields">For more information please visit
    /// https://developers.klaviyo.com/en/reference/api-overview#sparse-fieldsets</param>
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    ...
    /// <param name="campaignMessageFields">For more information please visit
    /// https://developers.klaviyo.com/en/reference/api-overview#sparse-fieldsets</param>
    /// <param name="campaignFields">For more information please visit
    /// https://developers.klaviyo.com/en/reference/api-overview#sparse-fieldsets</param>
    ...
    /// <param name="campaignSendJobFields">For more information please visit
    /// https://developers.klaviyo.com/en/reference/api-overview#sparse-fieldsets</param>
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    ...
    /// <param name="campaignSendJob">Permanently cancel the campaign, setting the status to CANCELED or revert the
    ...
    /// <param name="campaignRecipientEstimationJobFields">For more information please visit
    /// https://developers.klaviyo.com/en/reference/api-overview#sparse-fieldsets</param>
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    ...
    /// Recipient Estimation endpoint to retrieve the estimated recipient count for a given campaign.
    /// </summary>
    /// <param name="campaignRecipientEstimationJob">Trigger an asynchronous job to update the estimated number of
    /// recipients for the given campaign ID. Use the Get Campaign Recipient Estimation Job endpoint to retrieve the
    /// status of this estimation job. Use the Get Campaign Recipient Estimation endpoint to retrieve the estimated
