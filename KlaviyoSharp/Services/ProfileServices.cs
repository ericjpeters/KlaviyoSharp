...
public class ProfileServices : KlaviyoServiceBase, IProfileServices
{
                                                           ...
                                                           CancellationToken cancellationToken = default)
    {
        ...
        query.AddSort(sort);
        return await _klaviyoService.HTTPRecursive<Profile>(HttpMethod.Get, $"profiles/", _revision, query, null, null,
                                                            cancellationToken);
    }
    /// <inheritdoc />
    ...
    public async Task<DataObject<Profile>?> UpdateProfile(string? profileId,
                                                         ...
                                                         CancellationToken cancellationToken = default)
    {
        return await _klaviyoService.HTTP<DataObject<Profile>>(new("PATCH"), $"profiles/{profileId}/", _revision, null,
                                                               null, new DataObject<PatchProfile>(profile),
                                                               cancellationToken);
    }
    /// <inheritdoc />
    ...
    public async Task SuppressProfiles(ProfileSuppressionRequest supressions,
                                       CancellationToken cancellationToken = default)
    {
        await _klaviyoService.HTTP(HttpMethod.Post, "profile-suppression-bulk-create-jobs/", _revision, null, null,
                                   new DataObject<ProfileSuppressionRequest>(supressions), cancellationToken);
    }
    /// <inheritdoc />
    public async Task UnsuppressProfiles(ProfileUnsuppressionRequest unsupressions,
                                         CancellationToken cancellationToken = default)
    {
        await _klaviyoService.HTTP(HttpMethod.Post, "profile-suppression-bulk-delete-jobs/", _revision, null, null,
                                   new DataObject<ProfileUnsuppressionRequest>(unsupressions), cancellationToken);
    }
    /// <inheritdoc />
    public async Task SubscribeProfiles(ProfileSubscriptionRequest profileSubscriptions,
                                        CancellationToken cancellationToken = default)
    {
        await _klaviyoService.HTTP(HttpMethod.Post, "profile-subscription-bulk-create-jobs/", _revision, null, null,
                                   new DataObject<ProfileSubscriptionRequest>(profileSubscriptions), cancellationToken);
    }

    /// <inheritdoc />
    public async Task UnsuscribeProfiles(ProfileUnsubscriptionRequest profileUnsubscriptions,
                                         CancellationToken cancellationToken = default)
    {
        await _klaviyoService.HTTP(HttpMethod.Post, "profile-subscription-bulk-delete-jobs/", _revision, null, null,
                                                            ...
                                                            CancellationToken cancellationToken = default)
    {
        ...
        return await _klaviyoService.HTTP<DataListObject<List>>(HttpMethod.Get, $"profiles/{profileId}/lists/",
                                                               ...
                                                               CancellationToken cancellationToken = default)
    {
        ...
        return await _klaviyoService.HTTP<DataListObject<List>>(HttpMethod.Get, $"profiles/{profileId}/segments/",
                                                                _revision, query, null, null, cancellationToken);
    }
    /// <inheritdoc />
